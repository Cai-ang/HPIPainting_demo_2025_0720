...
namespace Oculus.Interaction
{
    public class Grabbable : PointableElement, IGrabbable
    {
        ...
        {
            TwoGrabTransformer = this.GetComponent<TwoGrabFreeTransformer>();
            OneGrabTransformer = this.GetComponent<OneGrabFreeTransformer>();
        ...
        protected override void Start()
        {
                ...
                TwoGrabTransformer == null)
            {
                if (this.tag == "pen")
                {
                    PenGrabFreeTransformer defaultTransformer = gameObject.AddComponent<PenGrabFreeTransformer>();
        ...
        private void UpdateTransform()
        {
            ...
            else _activeTransformer.UpdateTransform();
        }

...
namespace Oculus.Interaction.GrabAPI
{
    ...
    public class HandGrabAPI : MonoBehaviour
    {
        ...
        //3Dpainting
        public bool IsMiddleinposition(in GrabbingRule fingers, IFingerAPI fingerAPI)
        {
            if (fingerAPI.GetFingerIsGrabbing((HandFinger)0) && fingerAPI.GetFingerIsGrabbing((HandFinger)1))
            {
                return fingerAPI.GetFingerIsGrabbing((HandFinger)2);
            }
            else return false;
        }

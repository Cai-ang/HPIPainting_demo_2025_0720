...
namespace Oculus.Interaction
{
    ...
    public class InteractableGroupView : MonoBehaviour, IInteractableView
    {
        ...
        public virtual void Reset0()
        {
            List<UnityEngine.Object> interactables = new List<UnityEngine.Object>();
            interactables.Add(transform.parent.Find("GrabInteractable").GetComponent<GrabInteractable>());
            interactables.Add(transform.parent.Find("HandGrabInteractable").GetComponent<HandGrabInteractable>());
            // Interactables.Add(this.transform.parent.Find("GrabInteractable").GetComponent<GrabInteractable>());
            // Interactables.Add(this.transform.parent.Find("HandGrabInteractable").GetComponent<HandGrabInteractable>());
            Interactables = interactables.ConvertAll(mono => mono as IInteractable);

...
namespace Oculus.Interaction
{
    public class InteractableColorVisual : MonoBehaviour
    {
        ...
        {
            _normalColorState = new ColorState() { Color = GetComponentInChildren<MeshRenderer>().material.color };
            //Debug.Log("_normalColorState" + _normalColorState.Color);
        ...
        public virtual void Reset()
        {
            ...
            InteractableView = GetComponent<InteractableGroupView>() as IInteractableView;
            _colorShaderPropertyName = "_Color";
            _normalColorState = new ColorState() { Color = GetComponentInChildren<MeshRenderer>().material.color };
            Color nowColor;
            ColorUtility.TryParseHtmlString("#D4D4D4", out nowColor);
            _hoverColorState = new ColorState() { Color = nowColor };
            ColorUtility.TryParseHtmlString("#808080", out nowColor);
            _selectColorState = new ColorState() { Color = nowColor };
            _disabledColorState = new ColorState() { Color = new Color(1, 1, 1) };
        }
        public virtual void Reset0(Color color)
        {
            _normalColorState = new ColorState() { Color = color };
            SetColor(color);
        }

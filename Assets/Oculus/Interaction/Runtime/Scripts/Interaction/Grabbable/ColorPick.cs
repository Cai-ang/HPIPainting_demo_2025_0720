...
public class ColorPick : MonoBehaviour
{
    ...
    private void Start()
    {
        UpdateStauration();
        UpdateHue();
        //pen = GameObject.FindWithTag("pen").GetComponent<Pen_3D>();
    }
    ...
    {
        //Debug.Log("xxxxxxxxxxx" + sender.ClickPoint);
        var size2 = Saturation.rectTransform.sizeDelta / 2;
        var pos = Vector2.zero;
        pos.x = Mathf.Clamp(sender.ClickPoint.x * 2, -size2.x, size2.x);
    ...
    public void UpdateColor()
    {
        ...
        //更新画笔颜色
        pen.MenuSwitchColor(Paint.color);
    }
    ...
    public void OnHueClick(ColorPickClick sender)
    {
        ...
        var y = Mathf.Clamp(-sender.ClickPoint.x * 2, -h, h);
